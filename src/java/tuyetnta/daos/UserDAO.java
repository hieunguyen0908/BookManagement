...
public class UserDAO implements Serializable {
    ...
    public UserDTO checkLogin(String id, String password) throws NamingException, SQLException {
        ...
        try {
            ...
            String sql = "SELECT u.id, u.fullname, r.name AS roleName FROM dbo.users AS u JOIN dbo.roles AS r ON r.id = u.idRole WHERE u.id = ? AND u.password = ? AND u.status = 'active'";
