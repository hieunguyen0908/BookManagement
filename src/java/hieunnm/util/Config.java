...
//    public static String vnp_Returnurl = "http://localhost:8080/vnpay_jsp/vnpay_return.jsp";
    public static String vnp_Returnurl = "http://localhost:8080/BookManagement/vnpay_return.jsp";
    public static String vnp_TmnCode = "692UTW4G";
    public static String vnp_HashSecret = "HOTVOKPYUGIUNHCJSCWZFLFPEHUWVXDI";
